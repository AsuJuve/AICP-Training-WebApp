"""
Django settings for cp_training project.
...
WSGI_APPLICATION = 'cp_training.wsgi.application'
...
LOGGING = {
    ...
    'formatters': {
        'verbose': {
            'format' : "LOG2: [%(asctime)s] %(levelname)s [%(name)s:%(lineno)s] %(message)s",
            'datefmt' : "%d/%b/%Y %H:%M:%S"
        },
        'simple': {
            'format': 'LOG2: %(levelname)s %(message)s'
        },
    },
    'handlers': {
        'file': {
